...
export class StoricoAttivazioneService extends NextSDREntityProvider {

  constructor(protected _http: HttpClient, protected _datepipe: DatePipe) {
    super(_http, _datepipe, ENTITIES_STRUCTURE.ribaltoneutils.storicoattivazione, getInternautaUrl(BaseUrlType.RibaltoneUtils));
  }
}
